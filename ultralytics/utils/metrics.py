...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False, PIoU=False,PIoU2=False,Focal=False,
             alpha=1, gamma=0.5,Lambda=1.3, scale=False, eps=1e-7):
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or WIoU or PIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)  # convex (smallest enclosing box) width
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)  # convex height
        if CIoU or DIoU or EIoU or SIoU or WIoU or PIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
